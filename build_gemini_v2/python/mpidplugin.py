...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_mpidplugin')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_mpidplugin')
    _mpidplugin = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_mpidplugin', [dirname(__file__)])
        except ImportError:
            import _mpidplugin
            return _mpidplugin
        try:
            _mod = imp.load_module('_mpidplugin', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
class SwigPyIterator(_object):
    ...
    def __iter__(self):
        return self
SwigPyIterator_swigregister = _mpidplugin.SwigPyIterator_swigregister
...
class vectord(_object):
    ...
    def __init__(self, *args):
        this = _mpidplugin.new_vectord(*args)
        try:
    ...
    __del__ = lambda self: None
vectord_swigregister = _mpidplugin.vectord_swigregister
...
class vectori(_object):
    ...
    def __init__(self, *args):
        this = _mpidplugin.new_vectori(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
vectori_swigregister = _mpidplugin.vectori_swigregister
...
class MPIDForce(openmm.Force):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, MPIDForce, name, value)
    __swig_getmethods__ = {}
    for _s in [openmm.Force]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, MPIDForce, name)
    __repr__ = _swig_repr
    ...
    def __init__(self):
        this = _mpidplugin.new_MPIDForce()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    if _newclass:
        cast = staticmethod(_mpidplugin.MPIDForce_cast)
    else:
        cast = _mpidplugin.MPIDForce_cast
    if _newclass:
        isinstance = staticmethod(_mpidplugin.MPIDForce_isinstance)
    else:
        isinstance = _mpidplugin.MPIDForce_isinstance
    ...
    __del__ = lambda self: None
MPIDForce_swigregister = _mpidplugin.MPIDForce_swigregister
MPIDForce_swigregister(MPIDForce)

def MPIDForce_cast(force):
    return _mpidplugin.MPIDForce_cast(force)
MPIDForce_cast = _mpidplugin.MPIDForce_cast

def MPIDForce_isinstance(force):
    return _mpidplugin.MPIDForce_isinstance(force)
MPIDForce_isinstance = _mpidplugin.MPIDForce_isinstance
